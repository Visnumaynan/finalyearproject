...
export default function ResetPassword({ token, email }: { token: string; email: string }) {
    ...
    return (
        <AuthLayout title="New password" description="Set your new account password">
            ...
            >
                ...
                <div>
                    <label className="mb-1.5 block text-xs font-medium text-[#888]">New password</label>
                ...
                <div>
                    <label className="mb-1.5 block text-xs font-medium text-[#888]">Confirm new password</label>
                    <input
                        type="password"
